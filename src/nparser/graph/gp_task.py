...
class NNGraphParsingTask(NNTreeTask):
    def __init__(self, mstAlg, featReprBuilder, decoder, network, augmentScore):
        self.__mst = mstAlg
...
class NNGraphParsingTaskWithLbl(NNTreeTask):
    def __init__(self, mstAlg, featReprBuilder, decoder, network, augmentScore, lblDict):
        self.__mst = mstAlg
        self.__featReprBuilder = featReprBuilder
        self.__decoder = decoder
        self.__network = network
